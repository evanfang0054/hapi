        ...
        <div className="flex items-center justify-between px-2 pb-2">
            <div className="flex items-center gap-1">
                <ComposerPrimitive.AddAttachment
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--app-subtle-bg)] text-[var(--app-hint)] transition-colors hover:bg-[var(--app-bg)] hover:text-[var(--app-fg)] disabled:cursor-not-allowed disabled:opacity-50"
                >
                    <AttachmentIcon />
                </ComposerPrimitive.AddAttachment>
                ...
                {props.showExpandButton ? (
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full text-[var(--app-fg)]/60 transition-colors hover:bg-[var(--app-bg)] hover:text-[var(--app-fg)] disabled:cursor-not-allowed disabled:opacity-50"
                ...
                {props.showSettingsButton ? (
                    <button
                        ...
                        className="settings-button flex h-9 w-9 items-center justify-center rounded-full text-[var(--app-fg)]/60 transition-colors hover:bg-[var(--app-bg)] hover:text-[var(--app-fg)]"
                ...
                {props.showTerminalButton ? (
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full text-[var(--app-fg)]/60 transition-colors hover:bg-[var(--app-bg)] hover:text-emerald-500 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                {props.showAbortButton ? (
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full text-[var(--app-fg)]/60 transition-colors hover:bg-[var(--app-bg)] hover:text-red-500 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                {props.showSwitchButton ? (
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full text-[var(--app-fg)]/60 transition-colors hover:bg-[var(--app-bg)] hover:text-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                {isVoiceConnected && props.onVoiceMicToggle ? (
                    <button
                        ...
                        className={`flex h-9 w-9 items-center justify-center rounded-full transition-colors ${
                            props.voiceMicMuted
                                ? 'bg-[var(--app-subtle-bg)] text-[var(--app-hint)] hover:bg-[var(--app-panel-muted-bg)]'
